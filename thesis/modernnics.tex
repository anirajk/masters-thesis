...
where the NIC can receive and transmit directly from \linebreak application vectors. The Mellanox Infiniband ConnectX\textregistered-3
...
a bigger multiplier on transmission throughput than 1024~B records. For 128~B records, the ratio appears tumultuous across varying number of records, 
 ...
 introducing an unnecessary copy makes your transmission 3x less efficient in terms of memory utilisation.
