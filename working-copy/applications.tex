...
we saw that the memory pressure on the system is close to 12GB/s which is roughly half of what we evaluated our server is capable of. This implies 
that network transmission will bottlenecks available memory bandwidth for doing useful work such as processing data in a hybrid or analytical workload.
...
The experiments in Chapter~\cite{chap:modernnics} consider delivering a clean, ordered set of records to the
