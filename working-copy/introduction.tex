...
and networking can lead up 75\% reduction of CPU overhead and 25\% absolute savings and  get a throughput
boost of 1.8x compared to blindly using the kernel bypass available
