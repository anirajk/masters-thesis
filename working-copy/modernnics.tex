...
\item Comparison of different arrangements of small 128~B records to evaluate how to best exploit S/G DMA; Zero Copy, {\em when carefully tuned} offers better throughput and efficency. We outline precisely when Copy Out can be faster 
...
\input{fig-cycles}
The figure shows how many cycles of work the CPU needs to do
