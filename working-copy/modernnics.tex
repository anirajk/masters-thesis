...
a bigger multiplier on transmission throughput than 1024~B records. For 128~B records, the ratio appears tumultous across varying number of records, 
 ...
 2X memory bandwidth cost on copying out 1024~B records. Chapter~\ref{chap:bwtree} introduces a hybrid approach using a modern indexing structure to leverage 
...
\subsection{DDIO\textregistered savings in Copy Out}
...
that LLC bytes read from memory due to misses due to PCIe, we found our answer. 
