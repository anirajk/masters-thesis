...
\textbf{\blockquote{Scale-out in-memory stores are optimised for small requests
...
in RAMCloud and in conjunction with the benchmarks, delivers concrete suggestions
on how to design an fast and efficient migration protocol which causes minimal 
disruption.
